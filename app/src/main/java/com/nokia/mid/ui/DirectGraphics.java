...
public class DirectGraphics
{
    ...
    static {
        ...
        DirectGraphics.FLIP_VERTICAL = 16384;
    ...
    public void drawImage(final Image image, final int n, final int n2, final int n3, int n4) {
        if ((n4 & 0x2000) != 0x0) {
            n4 = DirectGraphics.transA[(n4 - 8192) / DirectGraphics.ROTATE_90 + 4];
        }
        else if ((n4 & 0x4000) != 0x0) {
            n4 = DirectGraphics.transB[(n4 - 16384) / DirectGraphics.ROTATE_90];
        }
        else {
            n4 = DirectGraphics.transA[n4 / DirectGraphics.ROTATE_90];
        }
        this.g.drawRegion(image, 0, 0, image.getWidth(), image.getHeight(), n4, n, n2, n3);
    }
    
    public void fillPolygon(final int[] array, final int n, final int[] array2, final int n2, final int n3, final int color) {
        this.g.setColor(color);
        this.g.fillTriangle(array[0], array2[0], array[1], array2[1], array[2], array2[2]);
        this.g.fillTriangle(array[0], array2[0], array[3], array2[3], array[2], array2[2]);
    }
}
