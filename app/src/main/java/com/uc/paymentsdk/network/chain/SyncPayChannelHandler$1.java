...
class SyncPayChannelHandler$1 implements Runnable {
   ...
   SyncPayChannelHandler$1(SyncPayChannelHandler var1) {
      super();
      this.this$0 = var1;
   }

   // $FF: synthetic method
   static SyncPayChannelHandler access$0(SyncPayChannelHandler$1 var0) {
      return var0.this$0;
   }

   public void run() {
      Integer var1 = SyncPayChannelHandler.access$0(this.this$0);
      synchronized(var1){}
