package com.uc.paymentsdk.util.DialogUtil$4;
...
class DialogUtil$4 implements DialogInterface$OnClickListener	// class@0000c2 from classes.dex
{
    private final Context val$context;
    private final int val$id;
    private final DialogUtil$WarningDialogListener val$listener;

    void DialogUtil$4(Context p0,int p1,DialogUtil$WarningDialogListener p2){
       this.val$context = p0;
       this.val$id = p1;
