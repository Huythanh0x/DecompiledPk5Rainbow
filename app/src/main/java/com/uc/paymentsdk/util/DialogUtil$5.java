package com.uc.paymentsdk.util.DialogUtil$5;
...
class DialogUtil$5 implements DialogInterface$OnCancelListener	// class@0000c3 from classes.dex
{
    private final Context val$context;
    private final int val$id;
    private final DialogUtil$WarningDialogListener val$listener;

    void DialogUtil$5(Context p0,int p1,DialogUtil$WarningDialogListener p2){
       this.val$context = p0;
       this.val$id = p1;
