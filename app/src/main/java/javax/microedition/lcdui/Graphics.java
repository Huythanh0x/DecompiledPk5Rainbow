...
public final class Graphics {
  ...
  static {
    ...
    arrayOfInt6[1] = 1;
    tTransXY = new int[][] { arrayOfInt3, arrayOfInt5, arrayOfInt1, arrayOfInt2, arrayOfInt4, arrayOfInt7, arrayOfInt6, { 1, 1 } };
    rect1 = new Rect();
    rect2 = new Rect();
  }
  ...
  public void drawRGB(int[] paramArrayOfint, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, boolean paramBoolean) {
    ...
    if (paramInt5 > 0 && paramInt6 > 0) {
      ...
      int j = paramArrayOfint[i1 / 2];
      int m = paramArrayOfint[i1 / 3];
      int n = paramArrayOfint[i1 / 4];
      int k = paramArrayOfint[i1 * 5 / 8];
      i1 = paramArrayOfint[i1 * 4 / 5];
      if (i == j && j == m && m == n && n == k && k == i1) {
  ...
  static {
    float[] arrayOfFloat2 = { 1.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 0.0F, 1.0F };
    float[] arrayOfFloat3 = { 1.0F, 0.0F, 0.0F, 0.0F, -1.0F, 0.0F, 0.0F, 0.0F, 1.0F };
    float[] arrayOfFloat5 = { -1.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 0.0F, 1.0F };
    float[] arrayOfFloat1 = { 0.0F, 1.0F, 0.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F };
    float[] arrayOfFloat4 = { 0.0F, -1.0F, 0.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F };
    tTrans = new float[][] { arrayOfFloat2, arrayOfFloat3, arrayOfFloat5, { -1.0F, 0.0F, 0.0F, 0.0F, -1.0F, 0.0F, 0.0F, 0.0F, 1.0F }, arrayOfFloat1, arrayOfFloat4, { 0.0F, 1.0F, 0.0F, -1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F }, { 0.0F, -1.0F, 0.0F, -1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F } };
  }
}


/* Location:              /Users/thanh0x/DevTools0x/Rb2.0vip-dex2jar.jar!/javax/microedition/lcdui/Graphics.class
