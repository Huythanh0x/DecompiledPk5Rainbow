...
public class Constants_H {
   ...
   static byte HALF_XCELLS;
   static byte HALF_YCELLS;
   ...
   public static int HEIGHT__ = 320;
   ...
   static {
      ...
      CwaActivity.getInstance().getWindowManager().getDefaultDisplay().getMetrics(var0);
      WIDTH__ = var0.widthPixels;
      HEIGHT__ = var0.heightPixels;
      WIDTH_H = WIDTH >> 1;
      HEIGHT_H = HEIGHT >> 1;
      XCELLS = (byte)(WIDTH / 20);
      YCELLS = (byte)(HEIGHT / 20);
