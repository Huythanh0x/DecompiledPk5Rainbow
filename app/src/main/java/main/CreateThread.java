...
extends Thread {
    ...
    public CreateThread(GameRun gameRun, int n) {
        this.gr = gameRun;
    ...
    public void run() {
         ...
         * 
         * java.lang.IllegalStateException: Backjump on non jumping statement @NONE, blocks:[] lbl17 : TryStatement: try { 1[TRYBLOCK]
         * 
