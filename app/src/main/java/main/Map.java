...
public class Map implements Key_H {
   ...
   public Map(GameRun var1) {
      ...
      byte[] var6 = new byte[]{0, 1};
      byte[] var4 = new byte[]{-1, 0};
      byte[] var2 = new byte[]{1, 0};
      this.dir_select = new byte[][]{var3, var5, var6, var4, var2};
      this.anoleSel = 0;
      this.npcDirTalk = -1;
      this.bDirTalk = false;
      this.checkNpcT = -1;
   ...
   private void addCloud(int var1) {
      ...
      short var2 = this.leftCol;
      int var3 = Constants_H.WIDTH;
      Ms.i();
      var4[0] = (short)(var2 * 20 + var3 + Ms.getRandom(Constants_H.WIDTH_H));
      var4 = this.cloud[var1];
      var2 = this.topRow;
      Ms.i();
      var4[1] = (short)(var2 * 20 + 20 + 2 + (Ms.getRandom(25) + 55) * var1);
      var4 = this.cloud[var1];
      Ms.i();
   ...
   private boolean checkMoveOff(int var1) {
      ...
      Npc var8;
      if (var1 > -1) {
         var3 = (byte)(this.npc[0][var1].x + 20 - this.my.x);
         var2 = (byte)(this.npc[0][var1].x - this.my.x - 20);
         byte var4 = (byte)(this.npc[0][var1].y + 20 - this.my.y);
         byte var5 = (byte)(this.npc[0][var1].y - this.my.y - 20);
   ...
   private void drawMapRect(byte var1, byte var2, int var3, boolean var4) {
      ...
      if (var4) {
         ...
         if (var3 == this.myMiniMap) {
            var12 = Ui.i();
            var7 = this.mapdataMap[var3][0];
            short var9 = this.mapoffx;
            var8 = this.mapdataMap[var3][1];
            var12.drawK1(var9 + var7 * var1, this.mapoffy + var8 * var2, var5, var6, 4);
         } else {
            var12 = Ui.i();
            var14 = this.mapdataMap[var3][0];
            var8 = this.mapoffx;
            var7 = this.mapdataMap[var3][1];
            var12.drawK0(var8 + var14 * var1, this.mapoffy + var7 * var2, var5, var6, 2);
         }

         GameRun var13 = this.gr;
         String var15 = this.gr.getNameCity(var3);
         byte var10 = this.mapdataMap[var3][0];
         ...
         var13.showStringM(var15, var10 * var1 + var11 + (var5 >> 1), var14 * var2 + var8 + (var6 >> 1) - 25, 4, var7);
         if (var3 == this.myMiniMap) {
   ...
   private void drawNpcAniOne(Npc[] var1, int var2) {
      ...
      short var5 = var1[var2].other[7];
      int var4 = var1[var2].now_action;
      int var3 = var5;
      if (var5 < 0) {
         var1[var2].dir = 4;
         var3 = (byte)(-var5);
      ...
      Ui var9 = Ui.i();
      Sprite var11 = npcSp[var6][var7];
      var3 = npcSp[var6][var7].action(var3, var4, 0);
      var4 = this.map_x;
      var5 = var1[var2].x;
      var7 = this.map_y;
      var6 = var1[var2].y;
      ...
      var9.drawFrameOne(var11, var3, var4 + var5 + 10, var7 + var6 + 19, var10);
   }
   ...
   private void drawSrcEffect() {
      boolean var4 = false;
      int var2 = Constants_H.WIDTH__;
      int var1 = Constants_H.HEIGHT__;
      int var3;
      if (this.srcFlash_c > 0) {
         var3 = this.srcFlash_c;
         this.srcFlash_c = (byte)(var3 - 1);
         if (var3 % 2 == 0) {
            Ui.i().fillRect(16777215, 0, 0, var2, var1);
         }
      }
      ...
      if (this.bSrc) {
         ...
         g.setColor(0);
         g.fillRect(0, this.black_width - var3 - this.bSrc_c, var2, var3);
         g.fillRect(0, var1 - this.black_width + this.bSrc_c, var2, var3);
      }

      if (this.my.state == 22) {
         Graphics var5 = g;
         if (this.eventGoing == 2) {
            var1 = var1 - this.gr.about_d.length * 29 >> 1;
         } else {
            var1 = 45;
         }
   ...
   private void loadMapData(int var1) {
      ...
      try {
         ...
         var14.read(var12);
         Ms.i();
         this.bgColor = (int)Ms.getNum(var12);
      ...
      while(true) {
         ...
         if (var5 != -1) {
            ...
            switch (var5) {
               case 1:
                  try {
                     this.bottomData = new short[var6];
            ...
            while(true) {
               ...
               while(true) {
                  ...
                  try {
                     ...
                     var14.read(var13);
                     Ms.i();
                     var7 = (short)((int)Ms.getNum(var13));
   ...
   private void loadMapModuleAndImage() {
      ...
      byte[][] var6 = Ms.i().create2Array(var3);
      byte[] var4 = (byte[])null;
      byte[][] var5;
      if (this.mapImg != null && var2[this.lastMap] == var2[this.mapNo]) {
         ...
         this.mapImg = null;
         this.mapImg = new Image[var6[var2[this.mapNo]].length];

         for(byte var1 = 0; var1 < var6[var2[this.mapNo]].length; ++var1) {
            this.mapImg[var1] = Ms.i().createImage("data/map/" + var6[var2[this.mapNo]][var1]);
         }
   ...
   private void runNpcAniOne(Npc[] var1, int var2) {
      byte var4 = (byte)(var1[var2].other[3] - 1);
      byte var6 = var1[var2].other[2];
      Ms.i();
      byte var5 = (byte)Ms.abs(var1[var2].other[7]);
      if (var1[var2].now_action >= npcSp[var4][var6].aLength(var5)) {
      ...
      var7.now_time = var3;
      if (var3 >= npcSp[var4][var6].action(var5, var1[var2].now_action, 1)) {
         var7 = var1[var2];
         ++var7.now_action;
   ...
   private void runSeek(Npc var1, boolean var2) {
      ...
      short var6 = (short)(var1.ix * 20);
      short var5 = (short)(var1.iy * 20);
      byte var3;
      if (var1.x == var6 && var1.y == var5) {
         if (var1.frame_c == -1) {
            var1.iy = -1;
            var1.ix = -1;
            if (var2) {
         ...
         int var8;
         if (var4) {
            if (var1.x > var6 && var1.x - var1.speed < var6 || var1.x < var6 && var1.x + var1.speed > var6) {
               var1.setSpeedXY(var6 - var1.x, 0);
            } else {
               if (var1.x > var6) {
                  var8 = -var1.speed;
               } else {
            ...
            if ((var1.y <= var5 || var1.y - var1.speed >= var5) && (var1.y >= var5 || var1.y + var1.speed <= var5)) {
               if (var1.y > var5) {
                  var8 = -var1.speed;
               } else {
                  var8 = var1.speed;
   ...
   public void bkgroundToPaint(short[] var1, Image[] var2, int var3, int var4, short[][] var5, Graphics var6, int var7, int var8, int var9, int var10, boolean var11) {
      if (var1 != null) {
         ...
         for(int var12 = 0; var12 < var1.length; var12 += 3) {
            if (var1[var12 + 2] >= 0) {
               int var16 = var1[var12 + 2] >> 3;
               short var13 = var1[var12 + 2];
               int var15 = var1[var12] * 20 - var3;
               int var17 = var1[var12 + 1] * 20 - (var4 - 20);
               short var14;
               if ((var13 & 3) % 2 == 1) {
                  var13 = var5[var16][4];
                  var14 = var5[var16][3];
               ...
               if (var15 + var13 >= var7 && var15 <= var9 && var17 >= var8 && var17 - var14 <= var10) {
                  Ui.i().drawRegion(var2[var5[var16][0]], var5[var16][1], var5[var16][2], var5[var16][3], var5[var16][4], var15, var17, 4 | 32, var1[var12 + 2] & 7, var6);
               }
            }
         }
      }
   ...
   Npc[] createNpc(byte[] var1, Npc[] var2) {
      ...
      if (this.mapInfo[this.mapNo * 2] > 0) {
         for(var3 = 0; var3 < var2.length; ++var3) {
            if (var2[var3].other[9] == 1) {
               for(var4 = 0; var4 < var2[var3].other.length; ++var4) {
                  var1 = var2[var3].other;
                  var6 = this.mapTemp[this.mapNo];
                  Ms.i();
                  var5 = Ms.skip2++;
                  var1[var4] = var6[var5];
               }
   ...
   void drawMap(Graphics var1) {
      ...
      int var5 = this.leftCol * 20;
      int var2 = this.topRow * 20;
      if (this.firstDrawMap == 0) {
         this.firstDrawMap = 1;
         this.bkgroundToPaint(this.bottomData, this.mapImg, var5, var2, this.moduleData, var1, 0, 0, Constants_H.OFF_WIDTH, Constants_H.OFF_HEIGHT, true);
      } else if (this.leftCol != var4 || this.topRow != var3) {
         var1.setClip(0, 0, Constants_H.OFF_WIDTH, Constants_H.OFF_HEIGHT);
         var1.copyArea(0, 0, Constants_H.OFF_WIDTH, Constants_H.OFF_HEIGHT, (var4 - this.leftCol) * 20, (var3 - this.topRow) * 20, 20);
         if (this.leftCol < var4) {
            this.bkgroundToPaint(this.bottomData, this.mapImg, var5, var2, this.moduleData, var1, 0, 0, (var4 - this.leftCol) * 20, Constants_H.OFF_HEIGHT, true);
         } else if (this.leftCol > var4) {
            this.bkgroundToPaint(this.bottomData, this.mapImg, var5, var2, this.moduleData, var1, Constants_H.OFF_WIDTH + (var4 - this.leftCol) * 20, 0, Constants_H.OFF_WIDTH, Constants_H.OFF_HEIGHT, true);
         }

         if (this.topRow < var3) {
            this.bkgroundToPaint(this.bottomData, this.mapImg, var5, var2, this.moduleData, var1, 0, 0, Constants_H.OFF_WIDTH, (var3 - this.topRow) * 20, true);
         } else if (this.topRow > var3) {
            this.bkgroundToPaint(this.bottomData, this.mapImg, var5, var2, this.moduleData, var1, 0, Constants_H.OFF_HEIGHT + (var3 - this.topRow) * 20, Constants_H.OFF_WIDTH, Constants_H.OFF_HEIGHT, true);
         }
      }
            ...
            do {
               ...
               switch (this.event[var2][this.event_now[var2]]) {
                  ...
                  case 21:
                     if (this.eventGoing == 0) {
                        this.eventGoing = 1;
                        var3 = this.event[var2][this.event_now[var2] + 2] * 100;
                        if (var3 < 0) {
                           int var4 = this.gr.money;
                           Ms.i();
                           if (var4 < Ms.abs(var3)) {
                              this.gr.say("\u91d1\u94b1\u4e0d\u8db3\uff01", 0);
                              this.eventGoing = 2;
                        ...
                        if (this.eventGoing == 1) {
                           ...
                           Ms.i();
                           var7.say(var14.append(Ms.abs(var3)).append("\u91d1").toString(), 0);
                        }
                     } else if (this.gr.say_c == 0) {
                        if (this.eventGoing == 2) {
   ...
   public void initNpcAni() {
      byte var2 = 0;
      byte[][] var6 = new byte[][]{new byte[100], new byte[5], new byte[60]};
      ...
      for(byte var3 = (byte)(this.npc.length - 1); var3 > -1; --var3) {
         for(byte var1 = (byte)(this.npc[var3].length - 1); var1 > -1; --var1) {
            var6[this.npc[var3][var1].other[3] - 1][this.npc[var3][var1].other[2]] = 1;
            if (var3 == 0) {
               this.npcList[var1 + 1] = var1;
               if (this.npc[var3][var1].other[8] == 1) {
                  byte[] var5 = this.gr.nidusMap;
      ...
      this.initNpcAni_1(100, 0, var6[0]);
      this.initNpcAni_1(5, 1, var6[1]);
      this.initNpcAni_1(60, 2, var6[2]);
      byte[][] var7 = (byte[][])null;
   ...
   public void initNpcAniOne(String var1, int var2, int var3) {
      Sprite[] var5 = npcSp[var3];
      Ms var6 = Ms.i();
      String var7 = "data/npc" + var3 + "/" + var1;
      boolean var4;
      if (var3 == 2) {
      ...
      var5[var2] = var6.createSprite(var7, var4);
   }
      ...
      if (this.npc != null) {
         for(byte var2 = 1; var2 < this.npcList.length; ++var2) {
            for(byte var3 = var2; var3 > 0; --var3) {
               short var4 = this.getNpcListY(var3);
               short var5 = this.getNpcListY(var3 - 1);
               if (var4 > var5) {
                  break;
               }

               if (var4 != var5 || var4 == var5 && this.npcList[var3 - 1] == -1) {
   ...
   public void paint_map(Graphics var1) {
      ...
      if (this.my.state == 6) {
         ...
         if (this.gr.view_state == 4) {
            ...
            var3 = Constants_H.HEIGHT__;
            var2 = Constants_H.WIDTH__ / 2;
            Ui.i().drawKuang(0, var3 - 25 * 3, var4, 25 * 3);
            var6 = this.gr;
            GameRun var7 = this.gr;
            byte var9 = this.gr.cur_a;
            var6.showStringM_(var7.getNameMonsterInfo((new byte[]{4, 25, 56})[var9]), var2, var3 - 25 * 2 - 8, 10, 3);
            byte[] var8 = (byte[])null;
         } else if (this.my.state == 16) {
            var3 = Constants_H.WIDTH__;
            var2 = Constants_H.HEIGHT__;
            int var5 = Constants_H.WIDTH__ / 2;
            var4 = Constants_H.HEIGHT__ / 2;
            Ui.i().drawKuang(0, var2 - 25 * 4, var3, 25 * 4);
            this.gr.showStringM_("\u662f\u5426\u56de\u590d\u6240\u6709\u5ba0\u7269\uff1f", var5, var2 - 25 * 4 + 4, 10, 3);
            this.gr.drawSelectMenu_(this.gr.action_str, var5 - 25 * 2, var4 - 25, 25 * 4, -1, 0, this.gr.popMenu);
            this.gr.showStringM_("\u6240\u9700\u91d1\u989d\uff1a" + this.gr.sell_money, var5, var2 - 25 * 3 + 4, 10, 3);
            this.gr.drawMoney(var5, var2 - 25 + 15, 3, false);
         }
         ...
         if (this.my.state == 19) {
            ...
            if (this.my.state == 23) {
               ...
               Ui.i().drawKuang(0, var2 - 25 * 2, var4, 25 * 2);
               Ui.i().drawString("\u662f\u5426\u4fdd\u5b58\u8fdb\u5ea6\uff1f", var3, var2 - 25 * 2 + 6, 17, 3, 0);
      ...
      if (this.my.state == 6) {
         ...
         if (this.my.state == 2 && this.eventGoing == 0) {
            ...
            if (this.gr.immueEnemy == 0) {
               ...
               GameRun var1 = this.gr;
               String[] var2 = this.gr.battleSay;
               Ms.i();
               var1.say(var2[Ms.getRandom(3)], 0);
               GameRun.mc.repaint();
