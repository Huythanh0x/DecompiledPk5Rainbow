    ...
    private void drawGame(int var1, int var2, int var3) {
        for(var1 = 0; var1 < this.findN.length; ++var1) {
            for(var2 = 0; var2 < this.findN[var1].length; ++var2) {
                ...
                this.drawCard(var1, var2, (var10 + var7) * var2 + var5 + var4, (var11 + var9) * var1 + var6 + var8, var14);
        ...
        if (this.count > 0) {
            ...
            StringBuilder var12 = new StringBuilder("可错次数：");
            if (this.time < 0) {
                var1 = 0;
            } else {
                var1 = this.time - 1;
            ...
            var13.showStringM(var12.append(var1).append("次").toString(), 320 + 200, 180 - 75, 5, 0);
        }
    ...
    public void draw0(int var1, int var2, int var3) {
        ...
        if (this.state == 0) {
            ...
            for(var2 = 0; var2 < this.gr.about_b.length; ++var2) {
                Ui var5 = Ui.i();
                String var6 = this.gr.about_b[var2].toString();
                byte var7;
                if (this.sel == var2) {
                    var7 = 0;
                } else {
                ...
                var5.drawString(var6, var1 + 200 + 15 + 25 + 26, var2 * 40 + var4 - 2, 0, var7, 1);
