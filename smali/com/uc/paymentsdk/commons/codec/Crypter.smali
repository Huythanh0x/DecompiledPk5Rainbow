...
.method private decipher([BI)[B
  ...
  .line 216
  .local v15, "l6":J
    const-wide/32 v17, -478700656
  .line 217
  .local v17, "l7":J
    const-wide v21, 4294967295L
    and-long v17, v17, v21
  .line 218
    const-wide/32 v19, -1640531527
  .line 219
  .local v19, "l8":J
    const-wide v21, 4294967295L
...
.method private writeInt(I)V
  ...
  .line 237
    ...
    ushr-int/lit8 v1, p1, 24
    invoke-virtual { v0, v1 }, Ljava/io/ByteArrayOutputStream;->write(I)V
  .line 238
    iget-object v0, p0, Lcom/uc/paymentsdk/commons/codec/Crypter;->baos:Ljava/io/ByteArrayOutputStream;
    ushr-int/lit8 v1, p1, 16
    invoke-virtual { v0, v1 }, Ljava/io/ByteArrayOutputStream;->write(I)V
  .line 239
    iget-object v0, p0, Lcom/uc/paymentsdk/commons/codec/Crypter;->baos:Ljava/io/ByteArrayOutputStream;
    ushr-int/lit8 v1, p1, 8
    invoke-virtual { v0, v1 }, Ljava/io/ByteArrayOutputStream;->write(I)V
  .line 240
    iget-object v0, p0, Lcom/uc/paymentsdk/commons/codec/Crypter;->baos:Ljava/io/ByteArrayOutputStream;
...
.method public decrypt([BII[B)[B
  .parameter "paramArrayOfByte1" # [B
  .parameter "paramInt1" # I
  .parameter "paramInt2" # I
  .parameter "paramArrayOfByte2" # [B
  .registers 15
  .prologue
    const/4 v9, 1
    const/4 v5, 0
  ...
  .line 43
    add-int/lit8 v3, p2, 8
    new-array v0, v3, [B
  .line 44
  .local v0, "arrayOfByte":[B
    rem-int/lit8 v3, p3, 8
    if-nez v3, :L2
    const/16 v3, 16
    if-ge p3, v3, :L3
  :L2
...
.method public encrypt([BII[B)[B
  ...
  .line 126
    add-int/lit8 v2, p3, 10
    rem-int/lit8 v2, v2, 8
    iput v2, p0, Lcom/uc/paymentsdk/commons/codec/Crypter;->pos:I
  .line 127
    iget v2, p0, Lcom/uc/paymentsdk/commons/codec/Crypter;->pos:I
    if-eqz v2, :L2
